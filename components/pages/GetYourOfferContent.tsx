...
export default function GetYourOfferContent() {
  ...
  const getOfferFaqs = [
    ...
    },
    {
      ...
      answer: "Yes! Leaseback options are available with both Immediate Offer and Advantage. You can sell and stay with short or long-term options, avoiding double moves and giving you time to find and prepare your next home."
    }
  ];
  ...
  return (
    <div className="get-offer-page">
      <style jsx>{`
        ...
        .get-offer-page .cta-box :global(.ilist-content) {
