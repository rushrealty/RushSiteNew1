  ...
  return (
    <div className="assurance-design-wrapper">
      <style>{`
        ...
        .assurance-hero h1 .gold {
            color: var(--gold);
        }

        .assurance-hero-tagline {
            font-size: 1.75rem;
            font-weight: 700;
            color: var(--gold);
            margin-bottom: 1rem;
        ...
        .assurance-guarantee-text {
            text-align: left;
        }

        .assurance-guarantee-text .label {
            font-size: 0.75rem;
            font-weight: 700;
            text-transform: uppercase;
        ...
        .assurance-guarantee-text .title {
            font-size: 1.25rem;
            font-weight: 700;
            color: var(--white);
        }

        .assurance-hero-cta-group {
            display: flex;
            gap: 1rem;
        ...
        .assurance-btn-primary:hover {
            background: #d4b366;
            transform: translateY(-2px);
            box-shadow: 0 10px 30px rgba(201, 169, 98, 0.3);
        }

        .assurance-btn-secondary {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
            padding: 1rem 2rem;
        ...
        .assurance-trust-item-icon svg {
            width: 22px;
            height: 22px;
            color: var(--black);
        }

        .assurance-trust-item strong {
            color: var(--black);
            font-weight: 700;
        }
        ...
        /* ═══════════════════════════════════════
           WHAT IS IT SECTION
        ═══════════════════════════════════════ */
        .assurance-what-is-section {
            padding: 100px 0;
            background: var(--white);
        }

        .assurance-what-is-grid {
            display: grid;
        ...
        .assurance-what-is-content p.highlight {
            font-size: 1.25rem;
            font-weight: 600;
            color: var(--black);
            padding-left: 1.5rem;
        ...
        .assurance-guarantee-card-amount {
            font-size: 4rem;
            font-weight: 900;
            color: var(--black);
            line-height: 1;
        ...
        .assurance-guarantee-card-title {
            font-size: 1.25rem;
            font-weight: 700;
            color: var(--gray-700);
            margin-bottom: 1.5rem;
        ...
        .assurance-guarantee-card-desc {
            font-size: 0.95rem;
            color: var(--gray-600);
            line-height: 1.7;
        }

        .assurance-seal-badge {
            position: absolute;
            top: 2rem;
            right: 2rem;
            width: 80px;
        ...
        .assurance-seal-badge .seal-text {
            font-size: 0.5rem;
            font-weight: 700;
            text-transform: uppercase;
            letter-spacing: 0.1em;
        ...
        .assurance-seal-badge .seal-icon {
            font-size: 1.5rem;
        }
        ...
        /* ═══════════════════════════════════════
           HOW IT WORKS
        ═══════════════════════════════════════ */
        .assurance-how-it-works-section {
            padding: 100px 0;
            background: var(--white);
        }

        .assurance-steps-container {
            max-width: 900px;
            margin: 0 auto;
        }
        ...
        .step-row:nth-child(even) .assurance-step-number {
            background: var(--gold);
            color: var(--black);
        }

        .assurance-step-number .num-label {
            font-size: 0.55rem;
            font-weight: 700;
            letter-spacing: 0.1em;
            text-transform: uppercase;
        ...
        .assurance-step-number .num {
            font-size: 1.75rem;
            font-weight: 900;
            line-height: 1;
        }

        .assurance-step-content {
            flex: 1;
            background: var(--gray-50);
            padding: 2rem;
            border-radius: 16px;
        ...
        /* ═══════════════════════════════════════
           SELLERS LOVE US
        ═══════════════════════════════════════ */
        .assurance-sellers-section {
            padding: 100px 0;
            background: var(--black);
            color: var(--white);
        }

        .assurance-sellers-section .assurance-section-label {
            color: var(--gray-400);
        }

        .assurance-sellers-section .assurance-section-title {
            color: var(--white);
        }

        .assurance-sellers-section .assurance-section-subtitle {
            color: var(--gray-400);
        }

        .assurance-sellers-grid {
            display: grid;
        ...
        .assurance-seller-benefit-icon svg {
            width: 28px;
            height: 28px;
            color: var(--black);
        }
        ...
        /* ═══════════════════════════════════════
           ELIGIBILITY & TERMS
        ═══════════════════════════════════════ */
        .assurance-terms-section {
            padding: 100px 0;
            background: var(--gray-50);
        }

        .assurance-terms-grid {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 2rem;
        }
        ...
        .assurance-terms-list {
            list-style: none;
            padding: 0;
            margin: 0;
        }

        .assurance-terms-list li {
            display: flex;
            align-items: flex-start;
            gap: 0.75rem;
            padding: 0.75rem 0;
        ...
        .assurance-terms-list li:last-child {
            border-bottom: none;
        }

        .assurance-terms-list li svg {
            flex-shrink: 0;
            width: 18px;
            height: 18px;
            margin-top: 3px;
        ...
        .terms-card.success .assurance-terms-list li svg {
            color: var(--success);
        }

        .terms-card.warning .assurance-terms-list li svg {
            color: var(--gray-400);
        }

        /* Payment Terms Card */
        .assurance-payment-terms-card {
            grid-column: 1 / -1;
            background: var(--black);
            color: var(--white);
            border-radius: 20px;
        ...
        .assurance-payment-term {
            padding: 1rem;
        }

        .assurance-payment-term-value {
            font-size: 2rem;
            font-weight: 800;
            color: var(--gold);
            margin-bottom: 0.5rem;
        ...
        .assurance-cta-section::before {
            ...
            animation: assurancePulse 10s ease-in-out infinite;
        }
        ...
        /* ═══════════════════════════════════════
           DISCLAIMER
        ═══════════════════════════════════════ */
        .assurance-disclaimer-section {
            padding: 3rem 2rem;
            background: var(--gray-100);
            border-top: 1px solid var(--gray-200);
        }

        .assurance-disclaimer-content {
            max-width: 900px;
            margin: 0 auto;
            text-align: center;
        }

        .assurance-disclaimer-content p {
            font-size: 0.75rem;
            color: var(--gray-500);
            line-height: 1.8;
            margin-bottom: 0.5rem;
        ...
        .assurance-disclaimer-content p:last-child {
            margin-bottom: 0;
        }
      ...
      <section className="assurance-hero">
        <div className="assurance-hero-content">
            <div className="assurance-hero-badge">
            ...
            <p className="assurance-hero-tagline">Speed. Confidence. Certainty.</p>
            
            <p className="assurance-hero-subtitle">When you buy with Rush Home, your offer comes with a $1,000 guarantee that gives sellers confidence to accept. Stand out in competitive markets with verified approval.</p>
            
            <div className="assurance-hero-guarantee-box">
                <span className="assurance-guarantee-amount">$1,000</span>
                <div className="assurance-guarantee-text">
                    <span className="label">Seller Protection</span>{" "}
                    <span className="title">Financing Guarantee</span>
                </div>
            </div>
            
            <div className="assurance-hero-cta-group">
                <a href="tel:302-219-6707" className="assurance-btn-primary">
                ...
                <button 
                    ...
                    className="assurance-btn-secondary"
                >
                    Learn How It Works
      ...
      {/* Trust Bar */}
      <section className="assurance-trust-bar">
        <div className="assurance-trust-bar-content">
            <div className="assurance-trust-item">
                <div className="assurance-trust-item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {/* What Is It Section */}
      <section className="assurance-what-is-section">
        <div className="assurance-container">
            <div className="assurance-what-is-grid">
                <div className="assurance-what-is-content">
                ...
                <div className="assurance-what-is-visual">
                    <div className="assurance-guarantee-card">
                        <div className="assurance-seal-badge">
                            <span className="seal-text">Guaranteed</span>
                            <span className="seal-icon">✓</span>
                        </div>
                        <div className="assurance-guarantee-card-amount">$1,000</div>
                        <div className="assurance-guarantee-card-title">Financing Guarantee</div>
                        <p className="assurance-guarantee-card-desc">If our qualified buyer&apos;s purchase doesn&apos;t close due to financing issues, we pay the seller $1,000. That&apos;s our commitment to bringing serious, qualified buyers who can actually close.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      {/* Benefits for Buyers */}
      <section className="assurance-benefits-section">
        <div className="assurance-container">
            <div className="assurance-section-header">
                <span className="assurance-section-label">Buyer Benefits</span>
                <h2 className="assurance-section-title">Why Buy With Rush Home?</h2>
                <p className="assurance-section-subtitle">Our Assurance Guarantee gives you advantages that make your offer stand out.</p>
            </div>

            <div className="assurance-benefits-grid">
                <div className="benefit-card">
                    <div className="assurance-benefit-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                            <polyline points="22 4 12 14.01 9 11.01"/>
                        </svg>
      ...
      {/* How It Works */}
      <section className="assurance-how-it-works-section" id="how-it-works">
        <div className="assurance-container">
            <div className="assurance-section-header">
                <span className="assurance-section-label">The Process</span>
                <h2 className="assurance-section-title">How It Works</h2>
                <p className="assurance-section-subtitle">Getting the Assurance Guarantee is simple. Here&apos;s what happens when you work with us.</p>
            </div>

            <div className="assurance-steps-container">
                <div className="step-row">
                    <div className="assurance-step-number">
                        <span className="num-label">Step</span>
                        <span className="num">01</span>
                    </div>
                    <div className="assurance-step-content">
      ...
      {/* Why Sellers Love Us */}
      <section className="assurance-sellers-section">
        <div className="assurance-container">
            <div className="assurance-section-header">
                <span className="assurance-section-label">Seller Perspective</span>
                <h2 className="assurance-section-title">Why Sellers Love Rush Home Buyers</h2>
                <p className="assurance-section-subtitle">Understanding what makes your offer more attractive to sellers.</p>
            </div>

            <div className="assurance-sellers-grid">
                <div className="seller-benefit">
                    <div className="assurance-seller-benefit-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                            <polyline points="22 4 12 14.01 9 11.01"/>
                        </svg>
      ...
      {/* Eligibility & Terms */}
      <section className="assurance-terms-section">
        <div className="assurance-container">
            <div className="assurance-section-header">
                <span className="assurance-section-label">Program Details</span>
                <h2 className="assurance-section-title">Eligibility &amp; Terms</h2>
                <p className="assurance-section-subtitle">Transparency is important. Here&apos;s exactly how the guarantee works.</p>
            </div>

            <div className="assurance-terms-grid">
                <div className="terms-card success">
                    ...
                    <ul className="assurance-terms-list">
                        <li>
                ...
                <div className="assurance-payment-terms-card">
                    <div className="assurance-payment-term">
                        <div className="assurance-payment-term-value">$1,000</div>
                        <div className="assurance-payment-term-label">Guarantee Amount</div>
                    </div>
                    <div className="assurance-payment-term">
                        <div className="assurance-payment-term-value">10 Days</div>
                        <div className="assurance-payment-term-label">Payment Timeline</div>
                    </div>
                    <div className="assurance-payment-term">
                        <div className="assurance-payment-term-value">Direct</div>
                        <div className="assurance-payment-term-label">From Rush Home</div>
                    </div>
                    <div className="assurance-payment-term">
                        <div className="assurance-payment-term-value">Any</div>
                        <div className="assurance-payment-term-label">Lender of Choice</div>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="assurance-cta-section">
        <div className="assurance-container">
            <div className="assurance-cta-content">
                ...
                <div className="assurance-cta-buttons">
                    <a href="tel:302-219-6707" className="assurance-btn-primary">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                        </svg>
                    ...
                    <Link href="/how-to-buy" className="assurance-btn-secondary">
                        View Buyer&apos;s Guide
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {/* Disclaimer */}
      <section className="assurance-disclaimer-section">
        <div className="assurance-disclaimer-content">
...
export default AssuranceContent;
