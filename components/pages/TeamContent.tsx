...
// Icon Components (matching AI Studio)
    ...
    <div className="team-page-wrapper">
      <style>{`
        ...
        @media (max-width: 768px) {
            .team-page-wrapper .container { padding: 0 1rem; }
          ...
          <div className="team-grid">
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1tyCqcmXqfRomChgCwuVawDGAurfzR_6e&sz=w1000" alt="Marcus Rush" referrerPolicy="no-referrer" />
              </div>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1-2cBqDDmGrlcZKWNhznlhVvMBJi2v1hx&sz=w1000" alt="Bert Ferguson" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
                <h3>Bert Ferguson</h3>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1zvfpYUydUHZ4r9tmeKaSr3nkh-FyjiIa&sz=w1000" alt="Alan Coffey" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
                <h3>Alan Coffey</h3>
                <div className="team-card-role">Agent</div>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1bXeZp4PABTooYRe6_aF_HL5lDMuSM67n&sz=w1000" alt="Chennita Crawford" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1Xj2P8NssHbgTsEh0Go4t1498OY8QnWOd&sz=w1000" alt="Kita Miller" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
                <h3>Kita Miller</h3>
                <div className="team-card-role">Agent</div>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1POlWrPKU5QmGU7m_g7gze81Sol4syLV-&sz=w1000" alt="Landy Coulanges" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1aZ2IRrJX7CScSrznEsx4DrtcVZt1KoMk&sz=w1000" alt="Jeremy Mayan" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
                <h3>Jeremy Mayan</h3>
                <div className="team-card-role">Agent</div>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=1myjPibmii3M5Tc9RAKbggmkQmkVXAVrz&sz=w1000" alt="Deja Johnson" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
                <h3>Deja Johnson</h3>
                <div className="team-card-role">Agent</div>
            ...
            <div className="team-card">
              <div className="team-card-image">
                <img src="https://drive.google.com/thumbnail?id=13DT6_FnIUfCdN3bA2E0OLuFALn2egBEu&sz=w1000" alt="Reycell Estolonio" referrerPolicy="no-referrer" />
              </div>
              <div className="team-card-content">
