...
const GetYourOffer: React.FC = () => {
  const [activeFaq, setActiveFaq] = useState<number | null>(null);

  useEffect(() => {
    // Set page title
    document.title = "Get Your Instant Cash Offer | Rush Home Team";

    // Load QuickBuy script with defensive checks
    const script = document.createElement('script');
    script.src = "https://rushhome.quickbuyoffer.com/scripts/falcon/auto-address.js?v=2.01";
    script.async = true;
    script.onerror = (err) => console.error("Error loading QuickBuy script", err);
    ...
    document.querySelectorAll('.value-card, .step-card, .choice-card, .lock-feature, .cta-box').forEach(el => {
      ...
      <section className="trust-bar">
        <div className="trust-bar-content">
            <div className="trust-item">
                ...
                <span><strong>Guaranteed</strong> backup contract</span>
            </div>
            <div className="trust-item">
                <div className="trust-item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="value-section">
        <div className="container">
            ...
            <div className="value-grid">
                {[
                  { title: "No Repairs Required", desc: "Sell as-is without spending time or money on repairs, updates, or staging. We buy homes in any condition.", icon: <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/> },
                  { title: "Close on Your Timeline", desc: "Need to move fast? Close in as few as 14 days. Need more time? Close in up to 60 days or stay in your home with flexible leaseback options.", icon: <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></> },
                  { title: "Certainty Guaranteed", desc: "No more wondering if your sale will fall through. Add Lock to hold your offer for 150 days while you list traditionally—use it whenever you're ready.", icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/> },
                  { title: "No Showings", desc: "Skip the disruption of keeping your home show-ready. No more last-minute cleanings or strangers walking through.", icon: <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></> },
                  { title: "Buy Before You Sell", desc: "Use your guaranteed offer to qualify for your next home. Make non-contingent offers and compete with cash buyers.", icon: <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/> },
                  { title: "Access Your Equity", desc: "Get cash from your equity instantly to fund improvements, pay down debt, or use as down payment on your next home.", icon: <><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></> }
                ].map((item, i) => (
      ...
      <section className="how-it-works">
        <div className="container">
            ...
            <div className="steps-grid">
                {[
                  { num: "01", title: "Enter Your Address", desc: "Tell us about your property by entering your home address above." },
                  { num: "02", title: "Get Your Offer", desc: "Receive a competitive cash offer within 24-48 hours—no obligation." },
                  { num: "03", title: "Choose Your Path", desc: "Select Immediate Offer or Advantage. Add Lock to list traditionally first." },
                  { num: "04", title: "Close & Get Paid", desc: "Close on your timeline and receive your funds. It's that simple." }
                ].map((step, i) => (
        ...
        <div className="container">
            ...
            <div className="choice-grid-3">
                ...
                <div className="choice-card">
                    <div className="choice-icon">
                        <img 
                          src="https://drive.google.com/thumbnail?id=1W4PbG9YVzOp2sWNGgJ7jKuNB3Ki1i0u-&sz=w1000" 
                          alt="QuickBuy" 
            ...
            <div className="lock-feature">
                ...
                <div className="lock-benefits">
                    {[
                      "150-day backup guarantee",
                      "List on open market",
                      "Accept offer anytime",
                      "Buy before you sell"
                    ].map((ben, i) => (
                      <div key={i} className="lock-benefit">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"/></svg>
                        <span>{ben}</span>
                      </div>
                    ))}
      ...
      <section className="faq-section">
        <div className="container">
            ...
            <div className="faq-grid">
                {[
                  { q: "How is my offer calculated?", a: "Your offer is based on comparable home sales in your area, current market conditions, and your property's condition. QuickBuy uses the same data real estate professionals use to determine fair market value, then provides a competitive cash offer." },
                  { q: "Is there any obligation to accept the offer?", a: "Absolutely not. Requesting an offer is completely free with no strings attached. You can review your options and decide what's best for your situation." },
                  { q: "What's the difference between Immediate Offer and Advantage?", a: "Immediate Offer is a single settlement—you access your home's equity right away with a simplified, fast process. Advantage is a dual settlement—you access most of your home's value immediately, then receive additional proceeds when the home sells on the open market, capturing all the upside. QuickBuy manages any repairs or improvements with Advantage." },
                  { q: "What is QuickBuy Lock?", a: "Lock is a back-up plan that holds your Immediate Offer or Advantage option open for 150 days while you list traditionally. It provides certainty that your home will sell (you can accept the QuickBuy offer anytime), and allows you to get pre-approved for a mortgage to buy before you sell—overcoming DTI hurdles." },
                  { q: "What types of homes qualify?", a: "QuickBuy works with most single-family homes, townhomes, and condos. The program is available in all 50 states and works for conventional loan financing. Enter your address to see if your home qualifies." },
                  { q: "Can I stay in my home after selling?", a: "Yes! Leaseback options are available with both Immediate Offer and Advantage. You can sell and stay with short or long-term options, avoiding double moves and giving you time to find and prepare your next home." }
                ].map((item, idx) => (
