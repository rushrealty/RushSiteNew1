...
const About: React.FC = () => {
  useEffect(() => {
    document.title = "About Rush Home Team | Delaware's Trusted Real Estate Experts | Compass";
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="about-page-wrapper">
      <style>{`
        ...
        .about-page-wrapper .hero {
            ...
            position: relative;
            overflow: hidden;
            padding-top: 125px; /* Increased padding by 10%+ to show badge more */
        }
      ...
      {/* Hero Section - Mirroring Screenshot Layout */}
        ...
        <div className="container">
            <div className="about-grid">
                <div className="about-image">
                    <img src="https://drive.google.com/thumbnail?id=1tyCqcmXqfRomChgCwuVawDGAurfzR_6e&sz=w1000" alt="Marcus Rush - Rush Home Team Leader" />
        ...
        <div className="container">
            <div className="coverage-grid">
                ...
                <div className="coverage-map">
                    <img src="https://drive.google.com/thumbnail?id=1rOVuTGz8ug0lXAtp7pMxqPrmGs_63i4-&sz=w1000" alt="Delaware Coverage Map" />
                </div>
            </div>
        </div>
      </section>

      {/* Compass Section - Logo centered over Brokered By */}
      <section className="compass-section">
        <div className="container">
            <div className="compass-grid">
                <div className="compass-logo-container">
                    <img src="https://drive.google.com/thumbnail?id=1AU6yfHqFniI1BpUqz4fQHJHNLbfw8dMp&sz=w1000" alt="Compass Real Estate" />
                    <p>Brokered By</p>
                </div>
        ...
        <div className="container">
            <div className="cta-content">
                ...
                <div className="cta-buttons">
                    <Link to="/get-offer" className="btn-primary-about">
                    ...
                    <Link to="/available-communities" className="btn-secondary-about">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="20" height="20">
