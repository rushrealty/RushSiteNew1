...
const Sell: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "How to Sell Your Home in Delaware | Rush Home Team";
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="how-to-sell-page">
      <style>{`
        ...
        .how-to-sell-page .hero {
            padding: 80px 2rem 40px; /* Reduced vertical padding */
        ...
        .how-to-sell-page .hero-badge {
            ...
            font-weight: 500;
            color: var(--gray-600);
            margin-bottom: 0.5rem; /* Tighter padding requested */
        }
        ...
        .how-to-sell-page .hero-subtitle {
            ...
            color: var(--gray-600);
            max-width: 600px;
            margin: 0 auto 1rem; /* Tighter padding requested */
            line-height: 1.6;
        }
